                      ...
                      <tbody>
                          @foreach($orders as $item)
                              ...
                              : ''}}
                                  ...
                                  <td>
                                      <select name="status" class="orderStatus form-control"
                                          item_id="{{ $item->id }}">
                               ...
                               <a href="{{ url('admin/order/detail/' . $item->id) }}"
                                  ...
                                  title="Edit User"><button class="mb-2 mr-2 btn btn-shadow-info btn-warning"><i
                                          class="pe-7s-edit" aria-hidden="true"></i></button></a>
                                  {!! Form::open([
                                  'method' => 'DELETE',
