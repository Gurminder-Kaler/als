...
<div class="card">
    <div class="card-header">
        <h3>Departments' List</h3> &nbsp; <a href="{{ url('/admin/department/create') }}"
            class="btn btn-primary btn-sm btn-dark" title="Add New Department">
                        ...
                        @foreach($departments as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {!! Form::open([
                                    'method' => 'POST',
                                    'url' => ['/admin/department/delete', $item->id],
